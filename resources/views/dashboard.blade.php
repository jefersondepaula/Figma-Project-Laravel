...
<div class="row">
    <div class="col-12 text-center">
        <img class="img-fluid" src="{{asset('../assets/img/video-dashboard.png')}}" alt="">
        <div class="col-9">
            <h4 class="video-title-dashboard text-left">Stair Lifts Feel The Freedom Of Your Home</h4>
            <h6 class="video-category-dashboard text-left ">Decoration</h6>
        </div>        
    </div>
</div>
<div class="row">
